...
export default function App() {
  ...
  return (
    <div className="relative flex flex-col h-screen bg-[#07090e] text-slate-100 font-sans overflow-hidden">
      ...
      {/* PROCESSING TOAST */}
      {processing && (
        <div></div> className="bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-slate-950 px-4 py-2 font-black text-center text-sm shadow-md animate-pulse flex items-center justify-center gap-2 print:hidden">
